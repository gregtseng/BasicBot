...
public static void main(String[] args){
	...
	for(int z=0;z<20;z++){
		System.out.println(slutty(jchats, "virgin"));
	}
	for(int x=0;x<30;x++){
		System.out.println(slutty(jchats,scan.nextLine()));
	}
	while(true){
		load=0;
		hits=0;
...
hits=0;
for(int d=0;d<janswers.length;d++){
	if(!janswers[d].content.contains("dick")||!janswers[d].content.contains("boob")||!janswers[d].content.contains("vag")
...
message[] clean=new message[hits+1];
clean[0]=new message();
clean[0].content="OMG I cant even right now";
for(int d=0;d<janswers.length;d++){
	if(!janswers[d].content.contains("dick")||!janswers[d].content.contains("boob")||!janswers[d].content.contains("vag")
	||!janswers[d].content.contains("fuck")||!janswers[d].content.contains("shit")||!janswers[d].content.contains("ass")||!janswers[d].content.contains("boobs")){
